...
public class ArticleController {
  ...
  public ResponseEntity<String> save(@RequestBody ArticleRequest articleRequest) {
    ...
    if (depot.isPresent()) {
      ...
      return new ResponseEntity<>(this.message.getSuccess(), HttpStatus.OK);
    }
    return new ResponseEntity<>("Die depot id " + articleRequest.getDepotId() + " ist unbekannt.", HttpStatus.BAD_REQUEST);
  }
